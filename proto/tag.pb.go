...
func (x *GetTagListReplay) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTagListReplay) ProtoMessage() {}

func (x *GetTagListReplay) ProtoReflect() protoreflect.Message {
	mi := &file_proto_tag_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTagListReplay.ProtoReflect.Descriptor instead.
func (*GetTagListReplay) Descriptor() ([]byte, []int) {
	return file_proto_tag_proto_rawDescGZIP(), []int{2}
}

func (x *GetTagListReplay) GetCode() uint32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *GetTagListReplay) GetList() []*Tag {
	if x != nil {
		return x.List
	}
	return nil
...
func (x *GetTagListReplay) GetPager() *Pager {
	if x != nil {
		return x.Pager
	}
	return nil
...
var file_proto_tag_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3d, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x54, 0x61, 0x67, 0x4c,
	...
	,
...
var file_proto_tag_proto_goTypes = []interface{}{
	...
	(*Tag)(nil),               // 1: Tag
	(*GetTagListReplay)(nil),  // 2: GetTagListReplay
	(*Pager)(nil),             // 3: Pager
}
var file_proto_tag_proto_depIdxs = []int32{
	1, // 0: GetTagListReplay.list:type_name -> Tag
	3, // 1: GetTagListReplay.pager:type_name -> Pager
	0, // 2: TagService.GetTagList:input_type -> GetTagListRequest
	2, // 3: TagService.GetTagList:output_type -> GetTagListReplay
